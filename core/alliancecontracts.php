									...
									if(isset($doctrine['doctrine_name'])) {
										...
										if($ship_id != NULL) {
											...
											if(isset($ship['fitting_name'])) {
												$doctrine_name = '<span class="label label-success" style="font-size: 85%; background-color: '.$doctrine_array[ucwords($contract['doctrine'])].'">'.ucwords($contract['doctrine']).'</label>';
