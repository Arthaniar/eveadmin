			...
			<div class="row" style="padding-left: 10px; padding-right: 10px; padding-top: 15px; padding-bottom: 15px">
				...
				<div class="col-md-4 col-sm-12">
					<div class="row opaque-section" style="background-image: none; background-color: transparent">
						...
						<div class="row" style="text-align: center; padding-top: 10px">
							...
							<a class="btn btn-primary" href="<?php echo $settings->getVoiceConnectionAddress($user->getUsername()); ?>">Connect To <?php echo $settings->getVoiceCommunications(); ?></a>
				...
				if($settings->getSlackIntegration()) {
					...
					<div class="col-md-4 col-sm-12">
						<div class="row opaque-section" style="background-image: none; background-color: transparent">
							<div class="row box-title-section">
								<h3 style="text-align: center"><?php if($settings->getSlackIntegration()) { echo $settings->GetGroupTicker().' Slack'; } else { 'Slack Integration Disabled'; }  ?></h3>
								<?php
